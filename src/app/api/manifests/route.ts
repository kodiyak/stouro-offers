    ...
    messages: [
      {
        role: "system",
        content: [
          "Você é um assistente especializado em processar pedidos.",
          "Seu trabalho é extrair informações enviadas pelo usuário e gerar um objeto JSON com os dados do pedido.",
          "---",
          "## Instruções Gerais",
          "- Você deve identificar a empresa responsável pelo pedido e usar o nome dela como cliente.",
        ...
        content: [
          {
            type: "text",
            text: [
              "Processe o pedido anexado, você deve extrair:",
              '1. Classifique o Documento: "INTERNAL" ou "EXTERNAL"',
              "2. Nome e Informações Adicionais do Cliente (NONE se não encontrar)",
              "3. Itens do Pedido: Descrição (Formatado como Título), quantidade (0 se não tiver CERTEZA) e preço unitário (0 se não tiver CERTEZA) de cada item",
              "---",
              "HANDWRITTEN: Pedido manual em folha de caderno.",
